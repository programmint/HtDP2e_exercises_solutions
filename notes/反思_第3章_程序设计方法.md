...
原以为：第 3 章的解题速度会快一些，哪知，更慢。

这一章主要讲：怎么样来设计程序（ How to Design Programs ），重在掌握其思路。
...
仅看到这里
 ...
 s 是具体代表了什么？不容易知道（后面的代码，我用黑色色块遮盖了）
...
视觉上，回返了一次，所需时间不过是几十微秒，可思考的进程，给破坏了。
...
这样子量级的需求，已经是复杂了。况且，需求来回拉扯，随意变动，前后矛盾，家常菜而已。
...
书里的设计思路，强调数据，数据总是放在最前面。

“签名”的意图，可以由后面的“目的声明”来补充，应对简单的程序，尚可，可面对复杂的程序，书中的愿望清单，应对起来，恐怕会很吃力。

一言概之，书里的思路 **这样子写，可不利于思考。**
