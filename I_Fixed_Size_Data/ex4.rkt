...
;4.1 题目
;这个题目看起来简单，实则未必，正如《代码大全2》（《Code Complete, 2nd Edition》）中所讲，降低复杂度是软件开发的核心。（Conquer Complexity）
;下面的文字会比较多，可以直接跳到 4.4 实现
...
;这样子处理，从该题目来说，是没有的的，但假如定义 i = 100 ，则结果会怎么样，显然 i 的值不对
